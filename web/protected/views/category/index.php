	...
	<ul class="category_list">
		...
		if (isset($category_list) && $category_list) {
			foreach ($category_list as $category_each) {
				...
				echo CHtml::link(CHtml::image(Yii::app()->baseUrl . '/static/img/category/' . $category_each->image, $category_each->name), Yii::app()->createUrl('category/list', array('category_id' => $category_each->id)));
