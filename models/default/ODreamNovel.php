...
class ODreamNovel extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('category_id, name, author, cover, download, fileSize, status, price, hot, update_time, ctime', 'required'),
			...
			array('id, category_id, name, author, cover, download, fileSize, status, price, hot, update_time, ctime', 'safe', 'on'=>'search'),
		);
	}
