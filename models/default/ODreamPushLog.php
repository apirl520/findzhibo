...
/**
 * This is the model class for table "dream_push_log".
 *
 ...
 */
class ODreamPushLog extends CActiveRecord
{
	/**
	 ...
	 * @return ODreamPushLog the static model class
	 */
