...
Yii::import('bootstrap3.widgets.input.BootInput');
...
class TbInputHorizontal extends TbInput
{
	...
	protected function getLabel()
	{
		if (isset($this->labelOptions['class']))
			$this->labelOptions['class'] .= ' col-xs-1 control-label';
		else
			$this->labelOptions['class'] = 'col-xs-1 control-label';
	...
	{
		$this->htmlOptions['checkbox-inline'] = true;
		$this->checkBoxList();
	}
	...
	protected function passwordField()
	{
		...
		echo $this->form->passwordField($this->model, $this->attribute, array_merge($this->htmlOptions, array('class' => 'form-control')));
		echo $this->getAppend();
		echo $this->getError() . $this->getHint();
		echo '</div>';
	}
	...
	{
		$this->htmlOptions['radio-inline'] = true;
	...
	protected function textArea()
	{
		echo $this->getLabel();
		echo '<div class="col-xs-10">';
		echo $this->form->textArea($this->model, $this->attribute, array_merge($this->htmlOptions, array('class' => 'form-control')));
		echo $this->getError() . $this->getHint();
		echo '</div>';
	}
	...
	protected function textField()
	{
		...
		echo '<div class="col-xs-10">';
		echo $this->getPrepend();
		echo $this->form->textField($this->model, $this->attribute, array_merge($this->htmlOptions, array('class' => 'form-control')));
		echo $this->getAppend();
		echo $this->getError() . $this->getHint();
		echo '</div>';
	}
	...
	{
		echo $this->getLabel();
		echo '<div class="col-xs-10"><div class="captcha">';
