...
Yii::import('bootstrap3.widgets.TbButton');
...
class TbButtonGroup extends CWidget {
	...
	public function run() {
		...
		foreach ($this->buttons as $button) {
			...
			$this->controller->widget('bootstrap3.widgets.TbButton', array(
			                                                              'buttonType' => isset($button['buttonType']) ? $button['buttonType'] : $this->buttonType,
			                                                              'type' => isset($button['type']) ? $button['type'] : $this->type,
			                                                              'size' => strpos($this->size, 'group-') === false ? 'group-' . $this->size : $this->size,
