...
Yii::import('bootstrap3.widgets.input.TbInput');
...
//	const TYPE_SEARCH = 'search';
	...
	// Input classes.
	const INPUT_HORIZONTAL = 'bootstrap3.widgets.input.TbInputHorizontal';
	const INPUT_INLINE = 'bootstrap3.widgets.input.TbInputInline';
//	const INPUT_SEARCH = 'bootstrap.widgets.input.TbInputSearch';
	const INPUT_VERTICAL = 'bootstrap3.widgets.input.TbInputVertical';
	...
	protected function inputsList($checkbox, $model, $attribute, $data, $htmlOptions = array()) {
		...
		if (isset($htmlOptions['checkbox-inline'])) {
			$labelCssClass .= ' checkbox-inline';
			unset($htmlOptions['checkbox-inline']);
		}
		if (isset($htmlOptions['radio-inline'])) {
			$labelCssClass .= ' radio-inline';
			unset($htmlOptions['radio-inline']);
		}
	...
	public function errorSummary($models, $header = null, $footer = null, $htmlOptions = array()) {
		if (!isset($htmlOptions['class']))
			$htmlOptions['class'] = 'alert alert-dange'; // Bootstrap error class as default
