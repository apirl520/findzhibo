...
// Button sizes.
	...
	/**
	 * @var bool indicates whether the button is Split button dropdowns
	 */
	public $split = false;
	...
	public function run() {
		...
		if ($this->hasDropdown()) {
			...
			if ($this->split) {
				...
				switch ($this->buttonType) {
					case self::BUTTON_BUTTON:
						echo CHtml::htmlButton('<span class="caret"></span>', $this->htmlOptions);
						break;
					case self::BUTTON_LINK:
					default:
						echo CHtml::linkButton('<span class="caret"></span>', $this->htmlOptions);
						break;
				}
			} else {
				$classes[] = 'dropdown-toggle';
			...
			$this->controller->widget('bootstrap3.widgets.TbDropdown', array(
